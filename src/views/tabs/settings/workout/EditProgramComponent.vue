...
import { modalController, IonLabel, IonIcon, IonInput, IonItem } from "@ionic/vue";
...
export default defineComponent({
  ...
  data() {
    return {
      tagInput: "",
      exercise: JSON.parse(JSON.stringify(this.program)),
      exerciseSchedule: JSON.parse((JSON.stringify(this.program.schedule))),
      filterValue: "",
    };
  },
});
